...
var testCases = []DoubleOpcodeTestCase{
	...
	{[]byte{0x7}, in.RotateA{WithCopy: true, Direction: in.RotateLeft}},
	{[]byte{0x17}, in.RotateA{Direction: in.RotateLeft}},
	{[]byte{0xF}, in.RotateA{WithCopy: true, Direction: in.RotateRight}},
	{[]byte{0x1F}, in.RotateA{Direction: in.RotateRight}},
	{[]byte{0xCB, 0x9}, in.RotateOperand{WithCopy: true, Direction: in.RotateRight, Source: registers.C}},
	{[]byte{0xCB, 0x16}, in.RotateOperand{WithCopy: false, Direction: in.RotateLeft, Source: registers.M}},
	{[]byte{0xCB, 0x29}, in.RotateOperand{Action: in.ShiftAction, WithCopy: true, Direction: in.RotateRight, Source: registers.C}},
	{[]byte{0xCB, 0x3E}, in.RotateOperand{Action: in.ShiftAction, WithCopy: false, Direction: in.RotateRight, Source: registers.M}},
	{[]byte{0xCB, 0x26}, in.RotateOperand{Action: in.ShiftAction, WithCopy: true, Direction: in.RotateLeft, Source: registers.M}},
}
