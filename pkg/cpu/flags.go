...
func lowerByteHalfCarry(a, b byte) bool {
	return int(a&0xf)+int(b&0xf) >= 0x10
}

func lowerByteFullCarry(a, b byte) bool {
...
func (cpu *CPU) isLCDCSet(flag LCDCFlag) bool {
	return (cpu.getLCDC() & byte(flag)) > 0
}
